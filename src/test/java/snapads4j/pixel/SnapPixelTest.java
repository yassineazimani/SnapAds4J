...
public class SnapPixelTest {
    ...
    public void get_pixel_associated_by_ad_account_should_success()
            ...
            SnapExecutionException, IOException {
    ...
    @Test
    public void test_get_pixel_associated_should_throw_SnapExecutionException() throws IOException {
    ...
    @Test
    public void should_throw_exception_400_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_401_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_403_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_404_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_405_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_406_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_410_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_418_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_429_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_500_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_503_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_1337_get_pixel_associated() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    public void get_specific_pixel_should_success() throws SnapResponseErrorException, SnapOAuthAccessTokenException,
            SnapArgumentException, SnapExecutionException, IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(200);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void test_get_specific_pixel_should_throw_SnapExecutionException() throws IOException {
        Mockito.when(httpClient.execute((Mockito.any(HttpGet.class)))).thenThrow(IOException.class);
    ...
    @Test
    public void should_throw_exception_400_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(400);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_401_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(401);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_403_get_specific_pixel() throws IOException {
    ...
    @Test
    public void should_throw_exception_404_get_specific_pixel() throws IOException {
    ...
    @Test
    public void should_throw_exception_405_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(405);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_406_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(406);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_410_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(410);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_418_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(418);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_429_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(429);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_500_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(500);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_503_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(503);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_1337_get_specific_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(1337);
        Mockito.when(httpClient.execute(Mockito.any(HttpGet.class))).thenReturn(httpResponse);
        Mockito.when(httpResponse.getEntity()).thenReturn(httpEntity);
    ...
    @Test
    public void should_throw_exception_401_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(401);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_403_update_pixel() throws IOException {
    ...
    @Test
    public void should_throw_exception_404_update_pixel() throws IOException {
    ...
    @Test
    public void should_throw_exception_405_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(405);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_406_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(406);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_410_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(410);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_418_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(418);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_429_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(429);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_500_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(500);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_503_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(503);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
    ...
    @Test
    public void should_throw_exception_1337_update_pixel() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(1337);
        Mockito.when(httpClient.execute(Mockito.any(HttpPut.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapPixel.updatePixel(oAuthAccessToken, pixel))
