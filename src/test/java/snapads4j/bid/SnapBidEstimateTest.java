...
public class SnapBidEstimateTest {
    ...
    @Test
    public void test_get_bid_estimate_by_squad_id_should_success() throws IOException,
    ...
    @Test
    public void should_throw_exception_400_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_401_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_403_get_bid_estimate_by_squad_id() throws IOException {
    ...
    @Test
    public void should_throw_exception_404_get_bid_estimate_by_squad_id() throws IOException {
    ...
    @Test
    public void should_throw_exception_405_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_406_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_410_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_418_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_429_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_500_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_503_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void should_throw_exception_1337_get_bid_estimate_by_squad_id() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
    ...
    @Test
    public void test_get_bid_estimate_by_squad_spec_should_success() throws IOException,
            SnapOAuthAccessTokenException, SnapResponseErrorException, SnapArgumentException, SnapExecutionException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(200);
    ...
    @Test
    public void test_get_bid_estimate_by_squad_spec_should_throw_SnapExecutionException() throws
            IOException {
    ...
    @Test
    public void should_throw_exception_400_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(400);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_401_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(401);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_403_get_bid_estimate_by_squad_spec() throws IOException {
    ...
    @Test
    public void should_throw_exception_404_get_bid_estimate_by_squad_spec() throws IOException {
    ...
    @Test
    public void should_throw_exception_405_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(405);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_406_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(406);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_410_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(410);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_418_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(418);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_429_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(429);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_500_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(500);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_503_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(503);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
    ...
    @Test
    public void should_throw_exception_1337_get_bid_estimate_by_squad_spec() throws IOException {
        Mockito.when(httpResponse.getStatusLine()).thenReturn(statusLine);
        Mockito.when(statusLine.getStatusCode()).thenReturn(1337);
        Mockito.when(httpClient.execute(Mockito.any(HttpPost.class))).thenReturn(httpResponse);
        assertThatThrownBy(() -> snapBidEstimate.getBidEstimateBySquadSpec(oAuthAccessToken, this.adAccountId, targetingSpecBidEstimate))
